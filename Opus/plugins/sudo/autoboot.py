    ...
    for x in ac_chats:
        try:
            await app.send_message(
                chat_id=int(x),
                text=f"<blockquote><b>{app.mention} ɪꜱ ʀᴇʙᴏᴏᴛɪɴɢ ᴛᴏ ᴇɴꜱᴜʀᴇ ꜱᴍᴏᴏᴛʜ ᴘʟᴀʏʙᴀᴄᴋ ᴀꜰᴛᴇʀ ʀᴜɴɴɪɴɢ ꜰᴏʀ ᴏᴠᴇʀ 2 ʜᴏᴜʀꜱ. 🎵\n\nʜᴏʟᴅ ᴏɴ ꜰᴏʀ ᴀʙᴏᴜᴛ 15-20 ꜱᴇᴄᴏɴᴅꜱ, ᴀɴᴅ ʏᴏᴜ’ʟʟ ʙᴇ ʙᴀᴄᴋ ᴛᴏ ᴇɴᴊᴏʏɪɴɢ ʏᴏᴜʀ ᴍᴜꜱɪᴄ ɪɴ ɴᴏ ᴛɪᴍᴇ!</b></blockquote>",
                parse_mode="html"  # HTML parse mode
            )
...
async def start_auto_restart(_, message):
    await message.reply_text(
        "<blockquote><b>ᴀᴜᴛᴏ-ʀᴇꜱᴛᴀʀᴛ ꜱᴛᴀʀᴛᴇᴅ. ᴛʜᴇ ʙᴏᴛ ᴡɪʟʟ ʀᴇꜱᴛᴀʀᴛ ᴇᴠᴇʀʏ 2 ʜᴏᴜʀꜱ.</b></blockquote>",
        parse_mode="html"  # HTML parse mode
    )
